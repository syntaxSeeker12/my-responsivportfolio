...
function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-r from-orange-100 to-white pt-20 gap-y-10 md:gap-y-0"
    >
      {/* Left Content */}
      ...
      <div className="flex justify-center items-center">
        <div className="relative w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden shadow-xl border-4 border-orange-300 animate-float">
          <img
